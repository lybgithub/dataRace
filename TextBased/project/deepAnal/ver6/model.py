...
class Model():
    ...
    def build_model(self):
        ...
        inputs = tf.concat([inputs_embedded, inputs_pre_embedded, inputs_post_embedded], axis=-1)
    ...
    def predict_class(self, sess, sentence_vector, sentence_vector_pre, sentence_vector_post, sentence_length):
